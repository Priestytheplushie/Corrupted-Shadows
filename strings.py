...
splash_messages = [
    # General Splash Messages
    "Welcome to Corrupted Shadows!",
    ...
    "Was that intended? Well, it is now...",
    ...
    "Made with Python!",
    "sys.quit(0)",
    "This game was originally called Priesty's Quest.",
    "Read the README!",
    "Some issues will never be resolved.",
    "Nighmare fuel!",
    "The ancient war rages on!",
    ...
    "Oops! All bugs!",
    "It's an empty world out there.",
    "It's a cruel world out there.",
    "The sky grows darker.",
    "The corruption beckons to you.",
    "Merge conflicts are the worst!",
    "The formatting is wack!",
    "Grind City, baby!",
    "Buy it now for $9.99!",
    "Watch the shadows!",
    ...
    "Any other story is NOT canon!",
    "Seems like a skill issue.",
    "Bolding is a bug!",
    "This appears on your discord profile!",
    # Tips
    "This game doesn't save!",
    "Don't waste your starting items!",
    "Corrupted Essence does nothing!",
    "Drop the shard!",
    "Orcs can stun!",
    "Goblins can steal!",
    "The Tower is a work in progress!",
    "Always pick the stat boosts!",
    "Hardcore mode is for the brave!",
    "Difficulty matters!",
    "Use a Cleansing Flute to purge the corruption!",
    "Hoarding items is a bad idea!",
    "Potent Potions are the best!",
    "Multi-battles are unfair!",
    "Cherish your items!",
    "AP doesn't transfer between battles!",
    "RNG is king!",
    "Each item use consumes 1 AP!",
    "Punching has a high miss chance!",
    "If an item breaks, it doesn't un-equip!",
    "You have unlimited inventory space!",
    "Defensive Stance is bugged!",
    "Levels increase more than just stats!",
    "XP is based on difficulty!",
    "The Orc's Mace deals AOE damage!",
    "The Goblin Dagger is a good starter weapon!",
    "Crafting doesn't exist yet!",
    "You are the main character!",
    "Stats influence decision making!",
    "The attack formula sucks!",
    "Mage's Fireballs can burn items!",
    "Burned items are lost forever!",
    "Speed determines turn order!",
    "Energy Ball is not based on strength!",
    "The game is not balanced!",
    "Armor soon???",
    "Always equip your best weapon!",
    "There is NO XP cap!",
    "Better items = better stats!",
    "Potions are consumables!",
    "Weapons have durability!",
    "Green means good, red means bad!",
    "10% chance to crit!",
    "Change the text speed in settings!",
    "The Tower operates under different rules!",
    "Tower difficulty is based on your level and floor count!",
    "Enemies scale fast!",
    "Check your character sheet to see your stats!",
    "Dying in the Tower fills the Corruption bar!",
    "Hardcore mode means 1 life only!",
    "Enemies don't drop items in the Tower!",
    "Weapons don't crit for some reason...",
    "Regular weapons are capped at maximum 50 damage!",
    "Orc's Mace is capped at 100 damage!",
    "You heal 10% of your max HP after each battle in the Tower!",
    "Corrupted Rules have drastic effects!",
]
