...
def intro(player):
    # Background
    animate_title(Fore.YELLOW+"Prelude: The Great War")
    time.sleep(3)
    clear_screen()
    typewriter(Fore.WHITE + "Fifty years after the" + Fore.MAGENTA + " Great War" + Fore.WHITE + ", the land still bears the scars of battle.")
    typewriter("The war between the" + Fore.YELLOW + " Iron Fist" + Fore.WHITE + " and the" + Fore.RED + " Crimson Legion" + Fore.WHITE + " raged for years, leaving a dark mark.")
    print("")
    time.sleep(2)
    typewriter("The Iron Fist emerged victorious, forcing the Legion to surrender deep within a cave.")
    typewriter("But in the shadows, something was born... something dark, something twisted.")
    print("")
    time.sleep(1)
    typewriter("A corruption, fueled by hatred and vengeance, spread across the land...")
    typewriter("It warped creatures, twisted nature, and consumed everything in its path.")
    print("")
    time.sleep(2)
    typewriter("Villages fell, monsters rose, and the world was plunged into chaos.")
    typewriter("Despite the world falling apart, the Iron Fist stood silent, watching from the shadows.")
    print("")
    time.sleep(1)
    typewriter("And now, fifty years later, you stand before the remnants of this broken world.")
